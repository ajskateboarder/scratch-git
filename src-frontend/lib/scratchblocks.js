export const scratchblocks = (function () {
  ...
  function _arrayLikeToArray(arr, len) {
    ...
    for (var i = 0, arr2 = [len]; i < len; i += 1) {
      arr2[i] = arr[i];
    }
    return arr2;
  }
  ...
  var movedExtensions = { pen: "pen", video: "sensing", music: "sound" };
  var extensions = _objectSpread2(
    _objectSpread2({}, movedExtensions),
    {},
    {
      tts: "tts",
      translate: "translate",
  ...
  var aliasExtensions = { wedo2: "wedo", text2speech: "tts" };
  var scratchCommands = [
    {
      id: "MOTION_MOVESTEPS",
      selector: "forward:",
  ...
  var overrideCategories = [
    ...
    _toConsumableArray(Object.keys(extensions)),
    _toConsumableArray(Object.keys(aliasExtensions)),
  );
  var overrideShapes = [
    "hat",
    "cap",
  ...
  specialCase("CONTROL_STOP", function (_, children, lang) {
    ...
    if (lang.osis.includes(value)) {
      return _objectSpread2(
        _objectSpread2({}, blocksById.CONTROL_STOP),
        {},
        { shape: "stack" },
      );
    }
    ...
    _createClass(Input, [
      ...
      },
      {
        ...
        value: function stringify() {
          ...
          var text = (this.value ? String(this.value) : "")
            .replace(/([\]\\])/g, "\\$1")
            .replace(/ v$/, " \\v");
          if (this.hasArrow) {
            text += " v";
  ...
  var Block = (function () {
    function Block(info, children, comment) {
      ...
      this.isCommand =
        shape === "stack" || shape === "cap" || /block/.test(shape);
    ...
    if (o) {
      ...
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
          ...
          var outlineChildren = children
            .splice(
              _lang.definePrefix.length,
              children.length - _lang.defineSuffix.length,
            )
            .map(function (child) {
  ...
  function isDefineBlock(children, lang) {
    ...
    for (var i = 0; i < lang.definePrefix.length; i += 1) {
      var defineWord = lang.definePrefix[i];
      var child = children[i];
      if (
        !child.isLabel ||
        minifyHash(child.value) !== minifyHash(defineWord)
      ) {
        return false;
      }
    }
    for (var _i = 1; _i <= lang.defineSuffix.length; _i += 1) {
      var _defineWord = lang.defineSuffix[lang.defineSuffix.length - _i];
      var _child = children[children.length - _i];
      if (
        !_child.isLabel ||
        minifyHash(_child.value) !== minifyHash(_defineWord)
      ) {
        return false;
      }
    }
  ...
  function parseLines(code, languages) {
    ...
    function peekNonWs() {
      for (var i = index + 1; i < code.length; i += 1) {
        if (code[i] !== " ") {
          return code[i];
        }
      }
    ...
    scripts.forEach(function (script) {
      ...
      eachBlock(script, function (block) {
        ...
        if (block.info.shape === "define-hat") {
          ...
          var info = { spec: spec, names: names };
  ...
  function parse(code, options) {
    options = _objectSpread2({ inline: false, languages: ["en"] }, options);
    if (options.dialect) {
  ...
  var document$1;
  var xml$1;
  var directProps$1 = { textContent: true };
  var SVG$1 = (function () {
    function SVG() {}
    _createClass(SVG, null, [
      {
        ...
        value: function init(window) {
          ...
          xml$1 = new DOMParser().parseFromString(
            "<xml></xml>",
            "application/xml",
          );
      ...
      },
      {
        ...
        value: function el(name, props) {
          var el = document$1.createElementNS(
      ...
      },
      {
        ...
        value: function symbol(href) {
          return SVG.el("use", { href: href });
        },
      },
      {
        key: "move",
        value: function move(dx, dy, el) {
          SVG.setProps(el, { transform: "translate(" + dx + " " + dy + ")" });
          return el;
        },
      },
      {
      ...
      },
      {
        ...
        value: function mouthRect(w, h, isFinal, lines, props) {
          ...
          return SVG.path(
            _objectSpread2(_objectSpread2({}, props), {}, { path: p }),
          );
        },
      },
      {
        ...
        value: function strikethroughLine(w, props) {
          return SVG.path(
            _objectSpread2(
              _objectSpread2({}, props),
              {},
              { path: ["M", 0, 0, "L", w, 0], class: "sb-diff sb-diff-del" },
            ),
          );
        },
      },
    ...
    function Filter(id, props) {
      this.el = SVG$1.el(
        ...
        _objectSpread2(
          _objectSpread2({}, props),
          {},
          { id: id, x0: "-50%", y0: "-50%", width: "200%", height: "200%" },
        ),
      );
      this.highestId = 0;
    }
    _createClass(Filter, [
        ...
        value: function fe(name, props, children) {
          ...
          this.el.appendChild(
            SVG$1.withChildren(
              SVG$1.el(
                "fe" + name,
                _objectSpread2(_objectSpread2({}, props), {}, { result: id }),
              ),
              children || [],
            ),
          );
      ...
      },
      {
        ...
        value: function offset(dx, dy, in1) {
          return this.fe("Offset", { in: in1, dx: dx, dy: dy });
        },
      },
      {
        key: "flood",
        ...
        value: function merge(children) {
          this.fe(
            ...
            children.map(function (name) {
              return SVG$1.el("feMergeNode", { in: name });
            }),
          );
        },
      },
      ...
      },
      {
        ...
        value: function darkRect(w, h, category, el) {
          return SVG$1.setProps(
            SVG$1.group([
              SVG$1.setProps(el, { class: "sb-" + category + " sb-darker" }),
            ]),
            { width: w, height: h },
          );
        },
      ...
      [
        ...
        },
        {
          ...
          value: function measure() {
            ...
            var cls = "sb-" + this.cls;
            this.el = SVG$1.text(0, 10, value, { class: "sb-label " + cls });
      ...
      [
        ...
        },
        {
          ...
          value: function draw(parent) {
            ...
            if (this.isColor) {
              SVG$1.setProps(el, { fill: this.value });
            } else if (this.isDarker) {
              el = darkRect(w, h, parent.info.category, el);
              if (parent.info.color) {
                SVG$1.setProps(el, { fill: parent.info.color });
              }
            }
            var result = SVG$1.group([
              SVG$1.setProps(el, { class: "sb-input sb-input-" + this.shape }),
            ]);
            if (this.hasLabel) {
      ...
      [
        ...
        },
        {
          ...
          value: function draw() {
            ...
            var padding =
              BlockView.padding[this.info.shape] || BlockView.padding.null;
            var pt = padding[0];
            var px = padding[1];
            var pb = padding[2];
            var y = 0;
            ...
            var lines = [];
            for (var _i = 0; _i < children.length; _i += 1) {
            ...
            var objects = [];
            for (var _i2 = 0, _lines = lines; _i2 < _lines.length; _i2 += 1) {
              ...
              try {
                for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
                  ...
                  if (_child.isArrow) {
                    objects.push(
                      SVG$1.move(innerWidth - 15, this.height - 3, _child.el),
                    );
                    continue;
                  }
                  ...
                  objects.push(
                    SVG$1.move(px + _child.x, (_line.y + _y) | 0, _child.el),
                  );
                  if (_child.diff === "+") {
                    var ellipse = SVG$1.insEllipse(_child.width, _child.height);
                    objects.push(
                      SVG$1.move(px + _child.x, (_line.y + _y) | 0, ellipse),
                    );
                  }
                }
              } catch (err) {
            ...
            if (this.info.color) {
              SVG$1.setProps(el, { fill: this.info.color });
            }
    ...
    _createClass(GlowView, [
      ...
      },
      {
        ...
        value: function drawSelf() {
          ...
          return SVG$1.setProps(el, { class: "sb-diff sb-diff-ins" });
        },
      },
      {
        key: "draw",
          ...
          try {
            for (_iterator4.s(); !(_step4 = _iterator4.n()).done; ) {
              ...
              if (diff === "-") {
                ...
                children.push(
                  SVG$1.move(x, y + dh / 2 + 1, SVG$1.strikethroughLine(dw)),
                );
                this.width = Math.max(this.width, block.width);
              }
              y += block.height;
    ...
    _createClass(DocumentView, [
      ...
      },
      {
        ...
        value: function exportSVG() {
          ...
          return (
            "data:image/svg+xml;utf8," + xml.replace(/[#]/g, encodeURIComponent)
          );
        },
      },
      {
  ...
  var document;
  var xml;
  var directProps = { textContent: true };
  var SVG = (function () {
    function SVG() {}
    _createClass(SVG, null, [
      {
      ...
      },
      {
        ...
        value: function roundRect(w, h, props) {
          return SVG.rect(
            w,
            h,
            _objectSpread2(_objectSpread2({}, props), {}, { rx: 4, ry: 4 }),
          );
        },
      },
      {
        ...
        value: function pillRect(w, h, props) {
          ...
          return SVG.rect(
            w,
            h,
            _objectSpread2(_objectSpread2({}, props), {}, { rx: r, ry: r }),
          );
        },
      },
      {
      ...
      },
      {
        ...
        value: function getHatTop(w) {
          return (
            "M 0 16 c 25,-22 71,-22 96,0 L " + (w - 4) + " 16 a 4 4 0 0 1 4 4"
          );
        },
      },
      {
        ...
        value: function catHat(w, h, props) {
          return SVG.group([
            ...
            SVG.move(
              ...
              SVG.setProps(
                SVG.group([
                  SVG.el("circle", { cx: 29.1, cy: -3.3, r: 3.4 }),
                  SVG.el("circle", { cx: 59.2, cy: -3.3, r: 3.4 }),
                  SVG.el("path", {
        ...
        value: function strikethroughLine(w, props) {
          return SVG.path(
            _objectSpread2(
              _objectSpread2({}, props),
              {},
              { path: ["M", 0, 0, "L", w, 0], class: "sb3-diff sb3-diff-del" },
            ),
          );
        },
      },
      ...
      [
        ...
        },
        {
          ...
          value: function measure() {
            ...
            this.el = SVG.text(0, 13, value, { class: "sb3-label " + cls });
            var cache = LabelView.metricsCache[cls];
            if (!cache) {
              cache = LabelView.metricsCache[cls] = Object.create(null);
            }
      ...
      [
        ...
        },
        {
          ...
          value: function draw(iconStyle, parent) {
            ...
            if (this.isColor) {
              SVG.setProps(el, { fill: this.value });
              ...
              if (parent.info.color) {
                SVG.setProps(el, { fill: "rgba(0, 0, 0, 0.15)" });
              }
            }
      ...
      [
        ...
        },
        {
          ...
          value: function drawSelf(iconStyle, w, h, lines) {
            ...
            return func(w, h, { class: "sb3-" + this.info.category });
          },
        },
        {
        ...
        },
        {
          ...
          value: function draw(iconStyle) {
            ...
            pushLine();
            var padLeft = children.length
              ? this.horizontalPadding(children[0])
              : 0;
            var padRight = children.length
              ? this.horizontalPadding(lastChild)
              : 0;
            ...
            for (var _i2 = 0; _i2 < lines.length; _i2 += 1) {
              ...
              var h = _line.height;
              for (var j = 0; j < _line.children.length; j += 1) {
                var _child = _line.children[j];
                if (_child.isArrow) {
                  objects.push(
                    SVG.move(innerWidth - 32, this.height - 28, _child.el),
                  );
                  continue;
                }
    ...
    _createClass(GlowView, [
      ...
      },
      {
        ...
        value: function drawSelf() {
          ...
          return SVG.setProps(el, { class: "sb3-diff sb3-diff-ins" });
        },
      },
      {
        key: "draw",
          ...
          try {
            for (_iterator3.s(); !(_step3 = _iterator3.n()).done; ) {
              ...
              if (diff === "-") {
                ...
                var dh = block.firstLine.height || block.height;
                children.push(
                  SVG.move(x, y + dh / 2 + 1, SVG.strikethroughLine(dw)),
                );
                this.width = Math.max(this.width, block.width);
              }
              y += block.height;
        ...
        value: function render(cb) {
          ...
          var icons =
            this.iconStyle === "high-contrast"
              ...
              : makeOriginalIcons();
          svg.appendChild(
            (this.defs = SVG.withChildren(SVG.el("defs"), icons)),
          );
          svg.appendChild(
  ...
  function init(window) {
    ...
    function newView$2(doc, options) {
      options = _objectSpread2({ style: "scratch2" }, options);
    ...
    function readCode(el, options) {
      options = _objectSpread2({ inline: false }, options);
  ...
  var scratchblocks = (window.scratchblocks = init(window));
